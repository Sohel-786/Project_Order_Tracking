...
const nextConfig = {
  ...
  eslint: {
    // This codebase has legacy hook-order lint issues in several pages.
    // Don't block production builds on ESLint; run `npm run lint` separately to clean up gradually.
