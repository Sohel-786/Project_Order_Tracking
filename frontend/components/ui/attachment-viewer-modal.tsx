...
export function AttachmentViewerModal({ isOpen, onClose, url, fileName }: AttachmentViewerModalProps) {
    ...
    if (showPdf && isOpen) {
        ...
        if (mounted && typeof document !== "undefined") return createPortal(pdfContent, document.body);
        return null;
    }
    ...
    if (isOpen && !showPdf && !showImage) {
        ...
        if (mounted && typeof document !== "undefined") return createPortal(fallbackContent, document.body);
        return null;
    }
